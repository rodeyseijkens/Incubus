...
//        return newObs;
    ...
    UI.prototype.getBridge = function() {
        ...
        var body1 = this.createBody({element: "bridge", classname: "bridge", type: "dynamic", x: 610, y: this.stage.height() - 220, w: 10, h: 200, figure: "box", ui: true});
        var body2 = this.createBody({element: "holder", classname: "holder", type: "static", x: 610, y: this.stage.height() - 10, w: 10, h: 10, figure: "box", ui: true});
